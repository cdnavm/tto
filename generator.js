...
<div class="fav-js">
<button class="bs-favs" card-id="${datos.id}" id="add-btn"><i class="fa-regular fa-heart"></i> Add to my list</button>
<button class="delete-btn none-btn" card-id="${datos.id}" id="remove-btn"><i class="fa-solid fa-trash"></i> Delete from my list</button>
</div>
</div>
...
<div class="bs-video-player">
    ...
    <ul class="bs-iframes">
        <li class="active">IFRAME HERE</li>
        <li>IFRAME HERE</li>
        <li>IFRAME HERE</li>
    </ul>
